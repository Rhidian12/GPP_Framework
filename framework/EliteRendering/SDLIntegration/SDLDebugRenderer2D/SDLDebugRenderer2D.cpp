...
void SDLDebugRenderer2D::DrawRectangle(const Elite::Rect& rectangle, const Color& color, float depth)
{
	depth -= DEPTH_SLICE_FINE_OFFSET;
	m_vLines.push_back(Vertex{ rectangle.bottomLeft,depth,color });
	m_vLines.push_back(Vertex{ Elite::Vector2{rectangle.bottomLeft.x + rectangle.width,rectangle.bottomLeft.y},depth,color });
	m_vLines.push_back(Vertex{ Elite::Vector2{rectangle.bottomLeft.x + rectangle.width,rectangle.bottomLeft.y + rectangle.height},depth,color });
	m_vLines.push_back(Vertex{ Elite::Vector2{rectangle.bottomLeft.x,rectangle.bottomLeft.y + rectangle.height},depth,color });
}
